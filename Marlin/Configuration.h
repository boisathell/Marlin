...
#define MACHINE_UUID "f9f85e87-a6b5-452b-99f8-41819e090068"
...
// This can protect components from overheating, but NOT fabrom shorts and failures.
...
*/
#define DEFAULT_AXIS_STEPS_PER_UNIT   {(100.0/3.0)*2.0, (100.0/3.0)*2.0, 9600.0/10.0, 385.0 * 1.0526}
...
/**
   ...
   Some examples:
     ...
     T |       3   | H <-- Example "3" (right+, front-)
       ...
       O-- FRONT --+
*/
#define NOZZLE_TO_PROBE_OFFSET { -9.8, 17.65, -1.635 }
