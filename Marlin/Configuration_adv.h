...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_PIN 21       // Set a custom pin for the controller fan
...
//#define BACKLASH_COMPENSATION
  ...
  #define BACKLASH_DISTANCE_MM { 0, 0, 0.1 } // (mm) One value for each linear axis
